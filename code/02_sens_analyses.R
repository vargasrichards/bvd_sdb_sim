...
#...............................................................................
  ...
  ## Visualise epidemic size
    ...
    ggsave(paste0(dir_path, "out/sens_n_seeds_cum_cases.png"),
  ...
  ## Compute and visualise extinction probability
    ...
    plot <- ggplot(df, aes(x = n_seeds, y = p_extinction, group = eff, 
      ...
      theme_bw()+
      theme(legend.position = "top", panel.grid.major.x = element_blank())
    ggsave(paste0(dir_path, "out/sens_n_seeds_p_extinction.png"),
      units = "cm", dpi = "print", height = 20, width = 20 * hw)
...
#...............................................................................
  ...
  ## Visualise epidemic size
    ...
    ggsave(paste0(dir_path, "out/sens_extreme_cum_cases.png"),
  ...
  ## Compute and visualise extinction probability
    ...
    plot <- ggplot(df, aes(x = cov, y = p_extinction, 
      ...
      theme_bw()+
      theme(legend.position = "none", panel.grid.major.x = element_blank())
    ggsave(paste0(dir_path, "out/sens_extreme_p_extinction.png"),
      units = "cm", dpi = "print", height = 15, width = 20 * hw)
